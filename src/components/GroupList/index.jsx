        ...
        {data.length &&
          data.map((element, idx) => (
            <li key={idx} className="grop_list_item">
              <h4 className="grup_list_card_paragraph">{element.GroupYonalish}</h4>
                ...
                <span className="grup_list_card_span">
                  <ul className="grup_list_card_top_list">
                    ...
                    <li className="grup_list_card_top_item">
                      ...
                      <p className="grup_list_card_top_text">{element.OqituvchTelNomer}</p>
                    </li>
                  </ul>
                </span>
              </div>
              <ul className="grup_list_card_bottom_list">
                <li className="grup_list_card_bottom_item">
                  ...
                  <p className="grup_list_card_bottom_text">{element.DarsKunlari}</p>
                </li>
                <li className="grup_list_card_bottom_item">
                  <p className="grup_list_card_bottom_p">Dars vaqti:</p>
                  <p className="grup_list_card_bottom_text">{element.DarsVaqti}</p>
                </li>
                <li className="grup_list_card_bottom_item">
